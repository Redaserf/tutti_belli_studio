    ...
    <div id="carouselExampleIndicators" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/Integradora/resources/imagenes/imagenejemplo2.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <div class="info-box">
              <img src="/Integradora/resources/imagenes/_CON.png" alt="" style="height: 60%; width: 60%;">
        ...
        <div class="carousel-item">
          <img src="/Integradora/resources/imagenes/imagenejemplo4.jpeg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <div class="info-box">
              <img src="/Integradora/resources/imagenes/_CON.png" alt="" style="height: 60%; width: 60%;">
  ...
  <nav id="navbar" class="navbar navbar-expand-lg fixed-top bg-body-tertiary" style="visibility: hidden;">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img src="/Integradora/resources/imagenes/Letras Tutti.png" alt="Tutti Belli Studio" width="300" height="60">
      </a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 mb-4">
              <img src="Integradora/resources/imagenes/horariotutti.jpg" alt="Horarios" class="img-fluid img-horario">
            </div>
            <div class="col-md-6">
      ...
      <section id="servicios" class="">
        ...
        <div class="container">
          <div class="card">
            <br>
              <img style="width: 80px;height: 80px;" src="/Integradora/resources/imagenes/imagenes_servicios_home/LABIOS_TARJETA.png" alt="labios">
              <br>
              <h3>Labios</h3>
          ...
          <div class="card">
            <br>
              <img style="width: 80px;height: 80px;" src="/Integradora/resources/imagenes/imagenes_servicios_home/OJOS_TARJETA.png" alt="Ojos">
              <br>
              <h3>Ojos</h3>
          ...
          <div class="card">
            <br>
              <img style="width: 70px;height: 50px;" src="/Integradora/resources/imagenes/imagenes_servicios_home/CEJA_TARJETA.png" alt="Ceja">
              <br>
              <br>
              <h3>Cejas</h3>
          ...
          <div class="card">
            <br>
              <img style="width: 70px;height: 50px;" src="/Integradora/resources/imagenes/imagenes_servicios_home/PESTAÑA_TARJETA.png" alt="Pestañas">
              <br>
              <br>
              <h3>Pestañas</h3>
      ...
      <section class="image-section">
        <div class="overlay">
          <img src="/Integradora/resources/imagenes/imagenejemplo4.jpeg" alt="Imagen separadora">
      ...
      <section id="cursos">
        ...
        <div class="container">
          <div class="card-2" style="width: 18rem;">
            <img src="/Integradora/resources/imagenes/imagenejemplo.jpeg" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card-2" style="width: 18rem;">
            <img src="/Integradora/resources/imagenes/imagenejemplo2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
              <p class="card-text">Domina el arte de realzar miradas con nuestro curso avanzado de Micropigmentación en Pestañas. Aprende técnicas innovadoras para destacar la belleza natural de cada ojo.</p>
              <a href="#" class="btn btn-primary">Go somewhere</a>
        ...
        <div class="container">
          <div class="text-center row justify-content-center">
            <div class="col-md-3 mb-4">
              <img src="Integradora/resources/imagenes/imagenejemplo.jpeg" class="rounded img-galeria" alt="...">
            </div>
            <div class="col-md-3 mb-4">
              <img src="Integradora/resources/imagenes/imagenejemplo.jpeg" class="rounded img-galeria" alt="...">
            </div>
      ...
      <section class="Pink_background_for_services_section" style="padding: 0px;">
        <div class="row">
          <img class="img-fluid" src="/Integradora/resources/imagenes/api.jpg" alt="">
        </div>
        <div class="row">
            ...
            <div  class="row text-center text-md-left">
              <br><br><br>
                <div class="col-md-4 text-center">
                    <img style="width: 400px;height: 100px;"src="/Integradora/resources/imagenes/Letras Tutti.png" alt="Tutti Belli Studio" class="img-fluid">
                </div>
                <div class="col-md-4">
                    <h5>Dirección</h5>
