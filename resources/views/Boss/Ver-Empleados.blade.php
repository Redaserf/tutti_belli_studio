...
<body class="hiddenX">
    ...
    <section class="home">
        <div class="container-full border">
            <h2 class="citas text-center mt-3">Empleados</h2>
            <a href="/Agregar-Empleado"><button class="btn btn-info">Registrar empleado</button></a>

            <br>
            <div>
                <!-- Aquí los empleados mediante back-end :c -->
            </div>
